...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UFLKMLObject *kml = [self.kmls objectAtIndex:indexPath.row];
    cell.textLabel.text = kml.title;
    cell.detailTextLabel.text = kml.subtitle;
    return cell;
